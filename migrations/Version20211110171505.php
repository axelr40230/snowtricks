 ...
 */
final class Version20211110171505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD category_id INT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP category_id, CHANGE created_at created_at DATE NOT NULL');
    }
}
